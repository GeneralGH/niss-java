...
public class SysLoginController extends BaseController {
    ...
    public ResultEntity login(@RequestBody UserLoginDTO param) {
        ...
        if ((user.getOpenid() == null || user.getOpenid().equals("")) && com.baomidou.mybatisplus.core.toolkit.ObjectUtils.isNotEmpty(param.getUuid())){
            String openid = WxUtil.getOpenIdService(param.getUuid());
    ...
    public ResultEntity loginSms(@Validated @RequestBody LoginSmsInput input, HttpServletResponse response) {
        ...
        if ((param.getOpenid() == null || param.getOpenid().equals("")) && com.baomidou.mybatisplus.core.toolkit.ObjectUtils.isNotEmpty(input.getUuid())){
            String openid = WxUtil.getOpenIdService(input.getUuid());
