...
public class SysRoleController extends BaseController {
    ...
    public ResultEntity allocatedList(SysUser user) {
    ...
    public ResultEntity unallocatedList(SysUser user) {
    ...
    public ResultEntity cancelAuthUserAll(Long roleId, Long[] userIds) {
        return ResultEntity.getOkResult(roleService.deleteAuthUsers(roleId, userIds));
    }
    ...
    public ResultEntity selectAuthUserAll(Long roleId, Long[] userIds) {
        roleService.checkRoleDataScope(roleId);
        return ResultEntity.getOkResult(roleService.insertAuthUsers(roleId, userIds));
    }
}
