...
public interface SysDepartmentMapper extends BaseMapper<SysDepartment> {
    ...
    IPage<SysDepartment> selectDeptListPage(Page<SysDepartment> page,@Param(Constants.WRAPPER) QueryWrapper<DeptQueryParam> wrapper);
     ...
     * @return 部门列表
     */
    public List<SysDepartment> selectChildrenDeptById(Long deptId);
     ...
     * @return 结果
     */
    public SysDepartment checkDeptNameUnique(@Param("deptName") String deptName, @Param("parentId") Long parentId);
    ...
    List<Long> selectDeptByAncestors(Long deptId);
}
