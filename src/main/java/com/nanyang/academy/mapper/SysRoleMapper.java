...
@Component
 public interface SysRoleMapper extends BaseMapper<SysRole> {
     ...
     * @return 角色数据集合信息
     */
     IPage<SysRole> selectRoleListPage(Page<SysRole> page, @Param(Constants.WRAPPER) QueryWrapper<RoleQueryParam> wrapper);
     ...
     * @return 选中角色ID列表
     */
    List<Long> selectRoleListByUser(Long userId);
