...
import com.nanyang.academy.utils.DetailToInput;
import com.nanyang.academy.utils.StringUtil;
import com.nanyang.academy.utils.TemplateUtil;
...
public class GenerateServiceImpl implements GenerateService {
    ...
    public void saveCode(GenerateInput input) {
        ...
        TemplateUtil.saveMapper(input);
        TemplateUtil.saveBean(input);
    }

    @Override
    public GenerateInput generate(List<BeanField> beanFields, GenerateInput input1) {
//        String tname = TemplateUtil.lowerFirstChar(name);
        GenerateInput input = DetailToInput.getTable(beanFields, input1);
        return input;
    }
}
