...
import java.util.Set;
 ...
 public interface SysRoleService extends IService<SysRole> {
     ...
     */
     ...
     IPage<SysRole> selectRoleListPage(RoleQueryParam param);
    ...
    List<SysRole> selectRoleListByUserId(Long userId);
     ...
     List<Long> selectRoleIdListByUser(Long userId);
     ...
     * @return 结果
     */
     int deleteAuthUser(SysRoleUser userRole);
     ...
     */
     ...
     Integer getUserRoleCount(Long roleId);
}
