...
import java.util.Set;
 ...
 public interface SysMenuService extends IService<SysMenu> {
     ...
     * @return 菜单列表
     */
     List<SysMenu> selectMenuList(MenuQueryParam menu);
     ...
     IPage<SysMenu> selectMenuListPlus(MenuQueryParam param);
     ...
     */
      ...
      * @return 下拉树结构列表
      */
     List<PermsTreeSelect> buildPermsTreeSelect(List<SysMenu> menus);

     List<PermsSelect> buildPermsSelect(List<SysMenu> menus);
