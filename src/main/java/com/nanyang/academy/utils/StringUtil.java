...
public class StringUtil extends StringUtils{
    ...
    public static boolean checkStringCN(String param){
        int n = 0;
    ...
    public static Double similarity(String target,String source){
        JaroWinkler jaroWinkler = new JaroWinkler();
        return jaroWinkler.similarity(target,source);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(similarity(b,c));
        System.out.println(similarity(c,a));
    }
