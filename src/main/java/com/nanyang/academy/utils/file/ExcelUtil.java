...
import com.nanyang.academy.annotation.Excel.ColumnType;
import com.nanyang.academy.annotation.Excel.Type;
import com.nanyang.academy.annotation.ExcelHandlerAdapter;
...
import com.nanyang.academy.utils.DictUtils;
import com.nanyang.academy.utils.StringUtil;
import com.nanyang.academy.utils.reflect.ReflectUtils;
...
public class ExcelUtil <T>{
     ...
     * @return 结果
     */
    public ResultEntity exportExcel(List<T> list, String sheetName)
    {
     ...
     * @return 结果
     */
    public ResultEntity exportExcel(List<T> list, String sheetName, String title)
    {
     ...
     * @return 结果
     */
    public ResultEntity importTemplateExcel(String sheetName)
    {
     ...
     * @return 结果
     */
    public ResultEntity importTemplateExcel(String sheetName, String title)
    {
     ...
     * @return 结果
     */
    public ResultEntity exportExcel()
    {
        ...
        try
        {
            ...
            wb.write(out);
            return ResultEntity.getOkResult(filename);
        }
        catch (Exception e)
        {
            log.error("导出Excel异常{}", e.getMessage());
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column)
    {
        ...
        try
        {
            ...
            if (attr.isExport())
            {
                ...
                cell.setCellStyle(styles.get("data_"));
    ...
    {
        String downloadPath = HengYuanConfig.getDownloadPath() + filename;
