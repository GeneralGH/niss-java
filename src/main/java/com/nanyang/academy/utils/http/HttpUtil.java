package com.nanyang.academy.utils.http;
...
public class HttpUtil {
    ...
    public HttpResult doPost(String url, Map<String, String> headers, Map<String, String> postData, String encoding) throws Exception {
        ...
        if (ObjectUtils.isNotEmpty(postData)){
    ...
    public static void main(String[] args) throws Exception {
        String bankNo = "JjdlOm6m/VVcpqtfJ3ubAg==";
        String jgAccount = "dv1A4Cx6";
        String url = "http://192.168.11.200:8080/xzhouse/jgApiAmountCollect/getList";
        Map param = new HashMap();
        param.put("bankNo", bankNo);
        param.put("jgAccount",jgAccount);

        Map header = new HashMap();
        /*header.put("bankNo", bankNo);
        header.put("jgAccount",jgAccount);*/
        HttpUtil util = new HttpUtil();
        HttpResult result = util.doPost(url,header,param, Constant.UTF8);
